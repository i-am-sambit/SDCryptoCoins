...
struct CryptoFilterOptions: OptionSet {
    ...
    static let active = CryptoFilterOptions(rawValue: 1 << 0)
    static let inactive = CryptoFilterOptions(rawValue: 1 << 1)
    static let token = CryptoFilterOptions(rawValue: 1 << 2)
    static let coins = CryptoFilterOptions(rawValue: 1 << 3)
